...
const services = [
  {
    ...
    description:
      "Achieve your fitness goals with customized training programs and expert guidance.",
    image: trainerImg,
    icon: (
      <svg
  ...
  },
  {
    title: "YOGA LESSON",
    description:
      "Find balance and relaxation with our guided yoga sessions for all skill levels.",
    image: yogaImg,
    icon: (
      <svg
        className="w-12 h-12 text-white"
  ...
  },
  {
    ...
    description:
      "Enhance your strength and reflexes with professional boxing and martial arts training.",
    image: boxingImg,
    icon: (
      <svg
        className="w-12 h-12 text-white"
  ...
  },
  {
    ...
    description:
      "Get professional coaching from the comfort of your home with our virtual programs.",
    image: onlineImg,
    icon: (
      <svg
        className="w-12 h-12 text-white"
      ...
      <div className="relative container mx-auto px-4 py-20">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12" data-aos="fade-up">
          {services.map((service, index) => (
            <div
              key={index}
              className="relative group overflow-hidden bg-black rounded-lg shadow-lg"
              data-aos="fade-up"
            >
